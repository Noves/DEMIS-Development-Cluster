...
| <a name="input_profile_provisioning_mode_vs_ars"></a> [profile\_provisioning\_mode\_vs\_ars](#input\_profile\_provisioning\_mode\_vs\_ars) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
| <a name="input_profile_provisioning_mode_vs_bedoccupancy"></a> [profile\_provisioning\_mode\_vs\_bedoccupancy](#input\_profile\_provisioning\_mode\_vs\_bedoccupancy) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
| <a name="input_profile_provisioning_mode_vs_core"></a> [profile\_provisioning\_mode\_vs\_core](#input\_profile\_provisioning\_mode\_vs\_core) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
| <a name="input_profile_provisioning_mode_vs_disease"></a> [profile\_provisioning\_mode\_vs\_disease](#input\_profile\_provisioning\_mode\_vs\_disease) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
| <a name="input_profile_provisioning_mode_vs_igs"></a> [profile\_provisioning\_mode\_vs\_igs](#input\_profile\_provisioning\_mode\_vs\_igs) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
| <a name="input_profile_provisioning_mode_vs_pathogen"></a> [profile\_provisioning\_mode\_vs\_pathogen](#input\_profile\_provisioning\_mode\_vs\_pathogen) | Provisioning mode for the FHIR Profiles services. Allowed values are: dedicated, distributed, combined | `string` | `"combined"` | no |
