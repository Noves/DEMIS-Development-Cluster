...
module "notification_processing_service" {
  ...
  istio_values = templatefile(local.nps_template_istio, {
    ...
    fhir_api_versions          = local.fhir_core_split_enabled ? module.validation_service_disease_metadata[0].current_profile_versions : module.validation_service_core_metadata[0].current_profile_versions
