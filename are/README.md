...
| <a name="module_are_namespace"></a> [are\_namespace](#module\_are\_namespace) | ../modules/namespace | n/a |
| <a name="module_are_namespace_quota"></a> [are\_namespace\_quota](#module\_are\_namespace\_quota) | ../modules/namespace_quota | n/a |
| <a name="module_are_services"></a> [are\_services](#module\_are\_services) | ./applications | n/a |
...
| <a name="input_target_namespace"></a> [target\_namespace](#input\_target\_namespace) | The Namespace to use for deployment | `string` | `"are"` | no |
